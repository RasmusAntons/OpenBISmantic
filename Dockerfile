...
COPY ./core-plugins/eln-lims/InstanceProfile.js core-plugins/eln-lims/1/as/webapps/eln-lims/html/etc/InstanceProfile.js
...
RUN echo "--requestlog" >> ./openBIS-server/jetty/start.d/logging.ini
